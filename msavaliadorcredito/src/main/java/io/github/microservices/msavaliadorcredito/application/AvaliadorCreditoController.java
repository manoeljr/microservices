...
import io.github.microservices.msavaliadorcredito.domain.model.DadosAvaliacao;
import io.github.microservices.msavaliadorcredito.domain.model.RetornoAvaliacaoCliente;
...
public class AvaliadorCreditoController {
    ...
    public ResponseEntity realizarAvaliacao(@RequestBody DadosAvaliacao dados) {
        try {
            RetornoAvaliacaoCliente retornoAvaliacaoCliente = avaliadorCreditoService.retornoAvaliacao(
